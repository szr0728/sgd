...
(function () {
    var $ = {
        $langList: [{name: "en", charset: "utf8"}, {name: "zh-cn", charset: "utf8"}, {name: "zh-tw", charset: "utf8"}],
        $skinList: [
            {name: "default", charset: "utf8"},
            {name: "whyGreen", charset: "utf8"},
            {name: "blue", charset: "utf8"},
            {name: "green", charset: "utf8"},
            {name: "ext", charset: "utf8"},
            {name: "blueFresh", charset: "utf8"}
        ],
        $wdate: true,
        $crossFrame: true,
        $preLoad: false,
    ...
    function I(G, _) {
        ...
        function E(F, E) {
            ...
            G.push("<script type=\"text/javascript\" src=\"" + A + "calendar.js?\"+Math.random()+\" charset=\"utf8\"></script>");
